...
class DashPage:
    ...
    def createprofilewidgets(self):
        ...
        self.sf=ctk.CTkFrame(master=self.mainsf)
        self.sf.pack(fill='both', expand=True)
        self.label5 = ctk.CTkLabel(master=self.sf, text="", image=ctk.CTkImage(Image.open("back1.jpg"), size=(900,600)), width=900, height=600) 
        self.label5.place(x=0, y=-45)
        pw.set_opacity(self.label5, value=1)
        self.sf.grid_rowconfigure(0, weight=0)
        self.sf.grid_rowconfigure(1, weight=1)
        self.sf.grid_columnconfigure(0, weight=1)

        
        self.holder=ctk.CTkFrame(master=self.sf, border_width=0, border_color="black", fg_color="#000001", bg_color="#000001")
        ...
        self.history=ctk.CTkLabel(master=self.sf, text="History: ", font=("Arial bold", 20), justify="left", bg_color="#000001")
        self.history.pack(anchor='nw', padx=56, pady=10)
        pw.set_opacity(self.history, color="#000001")
   
        self.mainpframe = ctk.CTkFrame(master=self.sf, width=360, height=1000, border_width=0, border_color="black", fg_color="#000001", bg_color="#000001")
        ...
        self.btn=ctk.CTkButton(master=self.holder, text="Back", height=20, width=60, fg_color="red", bg_color="#000001", 
                               command=lambda: self.launcher(self.sf, self.createdashwidgets))
    ...
    def createleaderboard(self):
        self.sf=ctk.CTkFrame(master=self.mainsf)
        self.sf.pack(fill='both', expand=True)
        self.label69 = ctk.CTkLabel(master=self.sf, text="", image=ctk.CTkImage(Image.open("back1.jpg"), size=(900,600)), width=900, height=600) 
        self.label69.place(x=0, y=-45)
        
        
        self.ld=ctk.CTkLabel(master=self.sf, text="Leaderboard", font=("Arial bold", 30), bg_color="#000001")
        self.ld.pack(padx=60, pady=(20,0))
        pw.set_opacity(self.ld, color="#000001")
        
        self.leaderboard=ctk.CTkFrame(master=self.sf, border_width=2, fg_color="#000001")
        ...
        self.wtf=ctk.CTkFrame(master=self.leaderboard, width=640, height=3300, fg_color="#1ecbe1")
        ...
        self.btn=ctk.CTkButton(master=self.sf, text="Back", height=50, width=50, fg_color="red", bg_color="#000001", 
                               command=lambda: self.launcher(self.sf, self.createdashwidgets))
    ...
    def countdown_page(self, topic):
        ...
        self.label1 = ctk.CTkLabel(master=self.sf, text="", image=background_image, width=900, height=600)
        self.label1.place(x=0, y=-45)
    
        # Countdown label
        self.count = ctk.CTkLabel(master=self.sf, text="", font=("Arial bold", 90), wraplength=800, bg_color="#000001")
        ...
        self.theme.configure(command=lambda: self.launcher(self.sf, self.createprofilewidgets))

    def start_countdown(self, topic):
        self.adder(self.sf)
        self.sf.after(2000, lambda: self.count.configure(text=str(3)))
        self.sf.after(3000, lambda: self.count.configure(text=str(2)))
        self.sf.after(4000, lambda: self.count.configure(text=str(1)))
        self.sf.after(5000, lambda: self.count.configure(text=str("GO")))
        self.sf.after(6000, self.create_quizwidgets, topic)
    ...
    def create_quizwidgets(self, topic):
        ...
        self.qnprogress=ctk.CTkProgressBar(master=self.sf, width=600, progress_color="yellow")
        self.qnprogress.pack(pady=(20,0))
        self.qnprogress.set(0)
        
        self.questions_label = ctk.CTkLabel(master=self.sf, text="", font=("Arial bold", 20), wraplength=800, bg_color="#000001")
    ...
    def display_question(self):
        ...
        if self.current_question < len(self.questions):
            ...
            for i in options:
                option_button = ctk.CTkButton(master=self.sf, text=i, font=("Arial bold", 15), fg_color="#efc1db", bg_color="#000001", text_color="black", width=300, height=40)
    ...
    def check_answer(self, selected_answer, correct_answer):
        ...
        if selected_answer == correct_answer:
            self.score += 1
        self.next_button = ctk.CTkButton(self.sf, text="Next", font=("Arial", 10), fg_color="yellow", text_color="black", command=self.next_question)
        self.next_button.pack(pady=(20, 20))

    def next_question(self):
        self.remover(self.sf)
    ...
    def end_quiz(self):
        ...
        self.backbtn=ctk.CTkButton(self.sf, text="Go back", font=("Arial bold", 16), width=120, height=60, corner_radius=8, 
                                   fg_color="#efc1db", text_color="black", command=lambda: self.launcher(self.sf, self.createdashwidgets))
